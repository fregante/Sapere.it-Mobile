	...
	B.definition.receive = function (data, status) {
		...
		if (status === 'success') {
			...
			if(/pagina non trovata/i.test(content)) {
				...
				content += '<footer><p>fonte: sapere.it</p><p><a href="https://github.com/fregante/Sapere.it-Mobile/issues/new?title=Problemi%20con%20la%20parola%20'+encodeURIComponent(B.input.word)+'">Segnala problemi con questa parola</a></p></footer>';
			}
		} else {
